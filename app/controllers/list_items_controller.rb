class ListItemsController < ApplicationController
  ...
  def create
    ...
    @list_item = @cart.add_product(params[:product_id])
    session[:counter] = 0


    respond_to do |format|
      if @list_item.save
        format.html { redirect_to @list_item.cart, notice: 'List item was successfully created.' }
  ...
  private
    ...
    def list_item_params
      params.require(:list_item).permit(:product_id, :cart_id)
    end
end
