...
class ListItemsControllerTest < ActionController::TestCase
  ...
  test "should create list_item" do
    ...
    assert_redirected_to list_item_path(assigns(:list_item).cart)
  end
  ...
  test "should update list_item" do
    patch :update, id: @list_item, list_item: { cart_id: @list_item.cart_id, product_id: @list_item.product_id }
